...
class GetUpAndDownloadSpeed {
    ...
    //获取总的上行速度
    fun getTotalUploadSpeed(): Float {                    //refreshTime : 刷新时间
        ...
        //计算上传速度
        totalUpSpeed =
            BigDecimal((mCurrentTotalUp / 1024) * 1000 / ((nowTimeStampTotalUp - lastTimeStampTotalUp) * 1.0)).setScale(
                defaultPointAmount,
    ...
    //获取指定进程的上行速度
    fun getUploadSpeedByUid(uid: Int): Float {
